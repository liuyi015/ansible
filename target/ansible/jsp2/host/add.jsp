...
<div id="AddHost">
	<h5>新建主机</h5>
	<form id="hostform" name="hostform" action="${pageContext.request.contextPath}/host/doAdd"method="post">
		...
		*name:<input type="text" name="name" value="${host.name }"/><br><br>
		...
		enabled:<input type="radio" name="enabled" value="true">true</input>
				<input type="radio" name="enabled" value="false">false</input><br><br>
		<input type="submit"  value="增加"  onclick="doAdd()" />
	</form>
</div>
</body>
</html>